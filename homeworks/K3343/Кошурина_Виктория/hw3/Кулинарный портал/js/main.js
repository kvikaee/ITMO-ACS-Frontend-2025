        ...
        <div class="col-md-4 mb-4">
            <div class="card recipe-card h-100">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="recipe.html?id=${recipe.id}" class="btn btn-primary mt-2" aria-label="Посмотреть рецепт ${recipe.title}">Посмотреть</a>
                </div>
            </div>
        </div>
    `;
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        <img src="${author.avatar || 'images/avatars/default.jpg'}" class="rounded-circle mb-3" width="80" height="80" alt="${author.name}">
                        <h2 class="h5">${author.name}</h2>
                        <p>${author.bio || ''}</p>
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 text-center">
                <div class="card-body d-flex flex-column">
                    ...
                    <h3 class="card-title h5">${author.name}</h3>
